...
<a href="#" class="sub-pro">
	...
	%>
           ...
           <a href="cart.jsp" style="text-decoration: none; color: black;  margin-left:38%;">   <button class="navbut bg-red text-white fs-100 fs-montserrat bold-500" style="text-decoration: none; transform:scale(0.7); " >Show More</button> </a>
          </div>
      </div>
