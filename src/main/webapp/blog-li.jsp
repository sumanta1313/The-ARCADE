      ...
      <div class="row tm-content-row">
        <div class="col-sm-12 col-md-12 col-lg-8 col-xl-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products" style="border-radius:25px;">
                ...
                <tbody>
                  <%
                    try {
                      ...
                      String sql = "SELECT bid, bname, bdate, bdetails1, image FROM blog";
                  ...
                  %>
                        <tr>
                          <td class="tm-product"><%= rs.getInt("bid") %></td>
                          <td class="tm-product"><%= rs.getString("bname") %></td>
                          <td class="tm-product"><%= rs.getString("bdate") %></td>
                          <td class="tm-product"><%= rs.getString("bdetails1") %></td>
                          <td class="tm-product">
                            <img style="width:100px;" src='Blog_search?bid=<%= rs.getString("bid") %>' />
                          </td>
           
                          <td>
                            <a href="delete_blog?bid=<%= rs.getString("bid") %>" class="tm-product-delete-link">
                              <i><img alt="" class="bin" style="width:22px;" src="image/recycle-bin.png"></i>
                            </a>
                          </td>
                          <td>
                            <a href="edit-blog.jsp?bid=<%= rs.getString("bid") %>" class="tm-product-delete-link">
            ...
            <a href="add-blog.jsp" class="btn btn-primary btn-block text-uppercase mb-3">Add new blog</a>
          </div>
        </div>
      </div>
    </div>
